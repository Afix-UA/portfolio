(() => {
        ...
        extendParams({
            hashNavigation: {
                ...
                getSlideIndex(_s, hash) {
                    ...
                    return swiper.getSlideIndex(utils_elementChildren(swiper.slidesEl, `.${swiper.params.slideClass}[data-hash="${hash}"], swiper-slide[data-hash="${hash}"]`)[0]);
                }
            }
        });
        const onHashChange = () => {
    ...
    function initSliders() {
        if (document.querySelector(".portfolio__slider")) new swiper_core_Swiper(".portfolio__slider", {
            modules: [ Navigation, HashNavigation, EffectCreative, Mousewheel, Keyboard, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            spaceBetween: 0,
            ...
            pagination: {
                ...
                clickable: true,
                renderBullet: function(index, className, prefix = "") {
                    const classArray = [ {
                        class: "_icon-home",
                        text: "Home"
                    }, {
                        ...
                        class: "_icon-experience",
                        text: "Experience"
                    } ];
                    const item = classArray[index];
                    if (item) return `<span class="${className} ${item.class}"><p>${item.text}</p></span>`; else return `<span class="${className}"></span>`;
                }
            },
            hashNavigation: {
                watchState: true
    ...
    function initSlidersProjects() {
        if (document.querySelector(".projects-swiper__slider")) new swiper_core_Swiper(".projects-swiper__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            grabCursor: true,
...
***************************************************************************** */
    ...
    function hoverItem() {
        ...
        if (items) items.forEach((item => {
            const button = item.querySelector(".projects-swiper__button");
            const image = item.querySelector(".projects-swiper__images img");
    ...
    class Typewriter {
        constructor(element, toRotate, period) {
            ...
            this.loopNum = 0;
            this.period = parseInt(period, 10) || 3e3;
            this.txt = "";
